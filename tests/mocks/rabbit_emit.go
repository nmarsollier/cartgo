...
// Source: ./internal/rabbit/emit/rabbit_emit.go
...
import (
	...
	emit "github.com/nmarsollier/cartgo/internal/rabbit/emit"
)
...
func (m *MockRabbitEmiter) SendArticleValidation(data emit.ArticleValidationData) error {
	m.ctrl.T.Helper()
